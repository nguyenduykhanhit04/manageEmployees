...
/**
 * Custom Hook quản lý hiển thị dữ liệu và xử lý lưu nhân viên cho màn hình Xác nhận thông tin nhân viên (ADM005).
 *
...
export function useAdm005() {
  ...
  // 4. Xử lý khi nhấn nút "OK" -> Gọi API lưu vào Database
  const handleOk = useCallback(async () => {
    ...
    try {
      ...
      // Chuẩn bị payload đúng chuẩn kiểu dữ liệu
      const payload = {
        ...
        // Chứng chỉ tiếng Nhật (nếu có chọn)
        certificationId:
